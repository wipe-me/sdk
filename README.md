...
- `javascript/` is the future `@wipe-me/sdk` npm package.
...
create, retrieve, delete, and health API clients with typed errors. Envelope encryption
and decryption remain the next fixture-first phase; no package will be published until
it passes the complete positive and negative interoperability suite.
